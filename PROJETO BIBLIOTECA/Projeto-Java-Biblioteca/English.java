...
public class English {
	...
	public English(String nome, String login, String senha, double saldo, int idade, int genero) {
	...
	public void menu() {
		...
		System.out.println("\nFICTION: ");
		System.out.println("\n(1)Outsider: ");
		System.out.println("\n(2)Dracula - Dark Edition: ");
		System.out.println("\n(3)Lost Journal of Gravity Falls ");
...
break;
		...
		if(escolha == 1) {
			...
			System.out.println("\t\t\tSINOPSE");
			System.out.println("\nThat summer, they faced the Thing for the first time, an evil supernatural being who left terrible bloodstains in Derry. "
			...
			System.out.println("\t\t\tSINOPSE");
			System.out.println("\nEmmy always knew that the forest around her house was full of ghosts and monsters. However, on the eve of her "
